...
export const CLIENTS = [
  { name: "SHALIMAR PELLET FEEDS LTD", category: "Feed" },
  { name: "SONAVETS PVT LTD", category: "Feed" },
  { name: "PREMIUM CHICK FEEDS PVT LTD", category: "Feed" },
  { name: "SUGUNA FOODS PRIVATE LIMITED", category: "Feed" },
  { name: "GODREJ AGROVET LTD", category: "Feed" },
  { name: "ABIS EXPORTS INDIA PVT LTD", category: "Feed" },
  { name: "JAPFA COMFEED INDIA PVT LTD", category: "Feed" },
  { name: "SKYLARK HATCHERIES PRIVATE LIMITED", category: "Feed" },
  { name: "ANMOL FEED PVT LTD", category: "Feed" },
  { name: "HITECH HATCH FRESH PVT LTD", category: "Feed" },
  { name: "DAYAL VETS PVT LTD", category: "Feed" },
  { name: "SALVA AGRO PVT LTD", category: "Feed" },
  { name: "GLOBUS SPRITS LTD", category: "Ethanol" },
  { name: "IFB AGRO INDUSTRIES LTD", category: "Ethanol" },
  { name: "RADICO KHAITAN", category: "Ethanol" },
  { name: "ITC LIMITED", category: "Ethanol" },
  { name: "CHANDIGARH DISTILLERS & BOTTLERS LTD", category: "Ethanol" },
  { name: "BCL INDUSTRIES LTD", category: "Ethanol" },
  { name: "GUJARAT AMBUJA EXPORTS LTD", category: "Starch" },
  { name: "ROQUETTE RIDDHI SIDDHI PVT LTD", category: "Starch" },
  { name: "SUKHJIT STARCH & CHEMICALS LTD", category: "Starch" },
  { name: "BLUECRAFT AGRO PVT LTD", category: "Starch" },
  { name: "BLUE OCEAN BIOTECH PVT LTD", category: "Starch" },
  { name: "Zuari Envien Bioenergy Pvt Ltd", category: "E & E" },
  { name: "D C N SUGAR", category: "E & E" },
  { name: "DHAMPUR SUGAR", category: "E & E" },
  { name: "SVAKSHA DISTILLERIES", category: "E & E" },
  { name: "ANKUR DISTILLERIES LTD", category: "E & E" },
  { name: "DHANUKA BIOTECH", category: "E & E" },
  { name: "HAPPY NIWAS", category: "E & E" },
  { name: "KAMAKHYA BIOFUEL", category: "E & E" },
  { name: "GULSAN POLYMAR", category: "E & E" },
  { name: "AADHAR GREEN", category: "E & E" },
  { name: "KG SPRIT", category: "E & E" },
  { name: "KEYAAN DISTILLERIES", category: "E & E" },
  { name: "COFCO INTERNATIONAL INDIA PVT LTD", category: "MNC" },
  { name: "LOUIS DREYFUS COMPANT", category: "MNC" },
  { name: "CARGILL INDIA PVT LTD", category: "MNC" },
  { name: "KN RESOURCES PVT LTD", category: "MNC" },
];
