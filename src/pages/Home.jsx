  ...
  return (
    <div data-testid="home-page" className="min-h-screen">
      ...
      <section className="relative min-h-[100svh] flex items-end pt-28 pb-40 lg:pb-44 overflow-hidden grain-overlay bg-[#1A1A1A]">
        ...
        <div className="relative z-10 px-6 md:px-12 lg:px-24 w-full grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-8">
            ...
            <h1
              className="font-serif-display text-[#FDFBF7] text-5xl md:text-7xl lg:text-[7.5rem] leading-[0.92] tracking-tighter animate-fade-up"
              style={{ animationDelay: "0.1s" }}
            >
              Bridging
              <br />
              <span className="italic font-light text-[#C48D3F]">
                harvests,
              </span>
              <br />
              building trust.
          ...
          <div
            className="lg:col-span-4 space-y-8 animate-fade-up"
            style={{ animationDelay: "0.3s" }}
          >
            <p className="text-[#FDFBF7]/85 text-base lg:text-lg leading-relaxed max-w-md">
              A physical commodity trading house specialising in cereals, oil
              seeds and feed supplements — moving cargo where it&rsquo;s needed,
              when it&rsquo;s needed.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link
                data-testid="hero-cta-primary"
                to="/commodities"
                className="group relative inline-flex items-center gap-2 px-6 py-3.5 bg-[#C48D3F] text-[#FDFBF7] text-sm tracking-wide overflow-hidden"
              >
              ...
              <Link
                ...
                to="/contact"
                className="group relative inline-flex items-center gap-2 px-6 py-3.5 border border-[#FDFBF7]/40 text-[#FDFBF7] text-sm tracking-wide overflow-hidden"
              >
          ...
          <div className="px-6 md:px-12 lg:px-24 py-5 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-0 md:divide-x divide-[#E5E0D8]">
            {STATS.map((s, i) => (
              ...
              >
                <CountUp
                  value={s.value}
                  className="font-serif-display text-3xl md:text-4xl text-[#1A1A1A] leading-none block"
                />
                <div className="text-[11px] tracking-[0.2em] uppercase text-[#4A4A4A] mt-2">
                  {s.label}
                </div>
              </m.div>
            ))}
          ...
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex items-center shrink-0">
              {COMMODITIES.map((c) => (
                <span
                  key={c.slug + i}
                  className="flex items-center gap-6 px-10 text-[#FDFBF7]/80 text-sm tracking-[0.2em] uppercase hover:text-[#C48D3F] transition-colors"
                >
                  {c.name}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <h2 className="font-serif-display text-4xl lg:text-5xl text-[#1A1A1A] leading-tight tracking-tight">
              A trading house that
              <br />
              understands the{" "}
              <em className="italic font-light text-[#C48D3F]">field</em>,<br />
              the <em className="italic font-light text-[#C48D3F]">
                freight
              </em>{" "}
              and the{" "}
              <em className="italic font-light text-[#C48D3F]">finish</em>.
            </h2>
          </div>
          <div className="lg:col-span-7 lg:pl-8 lg:border-l lg:border-[#E5E0D8] space-y-6 text-[#4A4A4A] leading-relaxed">
            <p>
              Hansaria Foods works at the intersection of agriculture, logistics
              and markets. We trade physical agricultural commodities — maize,
              wheat, broken rice, millet, soya bean D.O.C., mustard D.O.C. and
              DDGS — connecting Indian origins with feed millers, distilleries
              and processors across South and South-East Asia.
            </p>
            <p>
              Our professionals have worked as commercial principals, contract
              arbitrators, and production managers. That depth — of operating
              the trade, not just observing it — is what our clients buy when
              they buy from us.
            </p>
            <Link
              to="/about"
              data-testid="home-about-link"
              className="inline-flex items-center gap-2 text-sm text-[#1A1A1A] border-b border-[#C48D3F] pb-1 hover:gap-3 transition-all"
            >
      ...
      <section className="bg-[#F2F0EA] px-6 md:px-12 lg:px-24 py-24 lg:py-32 grain-overlay relative overflow-hidden">
        ...
        <div
          className="absolute bottom-20 -right-20 w-[400px] h-[400px] rounded-full bg-[#2C4C3B]/10 blur-3xl pointer-events-none animate-blob"
        ...
        <Reveal className="relative flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-16">
          <div>
            ...
            <h2 className="font-serif-display text-4xl lg:text-5xl text-[#1A1A1A] tracking-tight leading-tight">
              Commodities we{" "}
              <em className="italic font-light text-[#C48D3F]">specialise</em>{" "}
              in
            </h2>
          </div>
          <Link
            to="/commodities"
            data-testid="home-view-all-commodities"
            className="inline-flex items-center gap-2 text-sm border-b border-[#1A1A1A] pb-1 hover:border-[#C48D3F] hover:text-[#C48D3F] hover:gap-3 transition-all"
          >
            ...
            <RevealItem key={c.slug}>
              ...
              >
                <div className="absolute -top-2 -left-2 z-20 w-14 h-14 pointer-events-none">
                  <svg
                    className="absolute inset-0 spin-slower opacity-70"
                    viewBox="0 0 60 60"
                  >
                    <circle
                      cx="30"
                ...
                <div className="bg-[#FDFBF7] border border-[#E5E0D8] group-hover:border-[#C48D3F] transition-all duration-500 h-full flex flex-col overflow-hidden relative">
                  ...
                  <div className="relative aspect-[5/4] overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 bg-[#FDFBF7] px-3 py-1.5 border border-[#E5E0D8]">
                      <span className="text-[9px] tracking-[0.3em] uppercase text-[#C48D3F]">
                        {c.category}
                      </span>
                    </div>
          ...
          {SERVICES.map((s, i) => (
            <RevealItem key={s.title}>
              <div
                ...
                className="group border border-[#E5E0D8] bg-[#FDFBF7] flex flex-col hover-lift h-full"
              >
                ...
                <div className="p-8 flex-1 flex flex-col">
                  <div className="text-[10px] tracking-[0.3em] uppercase text-[#C48D3F] mb-3">
                    0{i + 1}
                  </div>
                  <h3 className="font-serif-display text-2xl text-[#1A1A1A] mb-4 group-hover:text-[#C48D3F] transition-colors">
                    {s.title}
                  </h3>
                  <p className="text-sm text-[#4A4A4A] leading-relaxed mb-6 flex-1">
                    {s.desc}
                  </p>
                  <Link
                    to="/services"
                    className="inline-flex items-center gap-2 text-sm text-[#1A1A1A] group-hover:text-[#C48D3F] transition-colors"
                  >
                    Learn more{" "}
                    <ArrowRight
                      size={14}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4">
            ...
            <h2 className="font-serif-display text-4xl lg:text-5xl tracking-tight leading-tight">
              A book built
              <br />
              on <em className="italic text-[#C48D3F]">breadth</em>.
            </h2>
            <p className="mt-6 text-[#FDFBF7]/70 leading-relaxed max-w-sm">
              Four product families. A dozen origin clusters. One disciplined
              trading desk.
            </p>
          </div>
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-px bg-[#FDFBF7]/15">
            {CATEGORIES.map((cat, i) => (
              <div
                ...
                className="bg-[#2C4C3B] p-8 lg:p-10"
              >
                <div className="text-[10px] tracking-[0.3em] uppercase text-[#C48D3F]">
                  0{i + 1}
                </div>
                <h3 className="font-serif-display text-3xl mt-4 mb-5">
                  {cat.name}
                </h3>
          ...
          {NEWS.map((n, i) => (
            <RevealItem key={i}>
              <article
                ...
                className="border border-[#E5E0D8] p-8 hover:border-[#C48D3F] transition-all duration-500 group cursor-pointer bg-[#FDFBF7] hover-lift h-full"
              >
                ...
                <h3 className="font-serif-display text-2xl text-[#1A1A1A] leading-snug mb-4 group-hover:text-[#C48D3F] transition-colors">
                  {n.title}
                </h3>
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            <h2 className="font-serif-display text-4xl lg:text-6xl text-[#FDFBF7] tracking-tight leading-tight">
              Have a cargo to move,
              <br />
              or a position to <em className="italic text-[#C48D3F]">cover</em>?
            </h2>
          </div>
          <div className="lg:col-span-5 space-y-5">
            <a
              ...
              className="flex items-center justify-between border border-[#FDFBF7]/30 px-6 py-5 text-[#FDFBF7] hover:bg-[#C48D3F] hover:border-[#C48D3F] transition-all group"
            >
              <span className="flex items-center gap-4">
                <Phone
                  size={18}
                  className="text-[#C48D3F] group-hover:text-[#FDFBF7]"
                />{" "}
                {COMPANY.phone}
              </span>
