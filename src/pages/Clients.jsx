...
const HANDSHAKE = "https://images.unsplash.com/photo-1521791136064-7986c2920216?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjY2NzZ8MHwxfHNlYXJjaHwzfHxidXNpbmVzcyUyMG1lZXRpbmclMjBjb3Jwb3JhdGUlMjBoYW5kc2hha2V8ZW58MHx8fHwxNzgyNzk2Mjc2fDA&ixlib=rb-4.1.0&q=85";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="font-serif-display text-3xl lg:text-4xl text-[#1A1A1A] italic leading-tight">
              &ldquo;Hansaria&rsquo;s desk doesn&rsquo;t just sell us a cargo — they tell us when not to buy. That&rsquo;s rare in this trade.&rdquo;
            </p>
            <div className="pt-6 border-t border-[#E5E0D8]">
              <div className="font-serif-display text-xl text-[#1A1A1A]">Head of Procurement</div>
              <div className="text-sm text-[#4A4A4A]">Leading South-Indian Feed Manufacturer</div>
            </div>
          </div>
        </div>
      </section>
